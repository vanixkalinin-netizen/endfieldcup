    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_460px]">
      <section className="panel p-7 md:p-8">
        ...
        <p className="mt-4 max-w-2xl text-white/60">
          Создайте аккаунт по нику и паролю. После этого мы сразу отправим вас
          в Telegram-бота, где аккаунт подтвердится за один шаг без почтовых
          кодов и лишних экранов.
        </p>
      </section>
